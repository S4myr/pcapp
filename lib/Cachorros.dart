...
class Cachorros extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Adote seu Cachorrinho'),
      ),
      drawer: SafeArea(
        child: Drawer(
          child: ListView(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              ...
                              image: const DecorationImage(
                                image: NetworkImage(
                                  'https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQAzNmq3wnD8hUBpEZYq4VBt4t33y5wtM-CJbbhQUyEC8puaUW-',
                                ),
                                fit: BoxFit.cover,
                              ),
                            ),
